...
// General constants
double config::PI = 3.1415926535897932;
...
// User Interface
unsigned int config::UPDATE_TIMER_INTERVALE = 10; //ms
...
int config::MAX_SPEED = 50;
int config::MAX_HEALTH = 5000;
int config::MAX_HUNGER = 2000;
int config::MAX_THIRST = 2000;
int config::MAX_SCORE = 1000;
unsigned int config::MAX_FEAR = 100;
