...
VisionSector::VisionSector(Coordinate &center, int angle1, int angle2, int range, std::vector<Entity>& entities) : m_center(center), m_angle1(angle1),
